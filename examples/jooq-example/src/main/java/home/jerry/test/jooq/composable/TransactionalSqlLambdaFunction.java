...
public class TransactionalSqlLambdaFunction implements TypedLambdaFunction<EventEnvelope, Object> {

    public static final String V1_DATA_SQL = "v1.data.sql.transaction";

    private final Map<String, Connection> coo = new ConcurrentHashMap<>();
